...
*/
    ...
    PdfSigAngMass_mF* pdf_sig_ang_mass = nullptr;
    PdfSigAngMass_mF* pdf_sig_ang_mass_penalty = nullptr;
    if (q2Bin < 5)  {
        pdf_sig_ang_mass = new PdfSigAngMass_mF( ("PDF_sig_ang_mass_"+shortString+"_"+year).c_str(),
        ...
        pdf_sig_ang_mass_penalty = new PdfSigAngMass_mF( ( "PDF_sig_ang_mass_penalty_"+shortString+"_"+year).c_str(),
 ...
 */   
    ...
    RooProdPdf* bkg_pdf = new RooProdPdf(Form("bkg_pdf_%i",years[iy]), Form("bkg_pdf_%i",years[iy]), RooArgList(*bkg_ang_pdf,*bkg_mass1));
  ...
  TFile* fout = 0;
  if (save) fout = new TFile(("simFitResults4d/simFitResult_data_fullAngularMass_Swave_FlmF" + all_years + stat + Form("_b%i.root", q2Bin)).c_str(),"RECREATE");
  ...
  */
  ...
  c[confIndex]->SaveAs( ("plotSimFit4d_d/simFitResult_data_fullAngularMass_Swave_FlmF" + plotString +  ".pdf").c_str() );
