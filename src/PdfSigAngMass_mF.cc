...
ClassImp(PdfSigAngMass_mF) 

PdfSigAngMass_mF::PdfSigAngMass_mF(const char *name, const char *title, 
		     RooAbsReal& _ctK,
		     RooAbsReal& _ctL,
		     RooAbsReal& _phi,
		     RooAbsReal& _m,
...
PdfSigAngMass_mF::PdfSigAngMass_mF(const PdfSigAngMass_mF& other, const char* name) :  
...
Double_t PdfSigAngMass_mF::evaluate() const 
{
...
Int_t PdfSigAngMass_mF::getAnalyticalIntegral(RooArgSet& allVars, RooArgSet& analVars, const char* rangeName) const
{
...
Double_t PdfSigAngMass_mF::analyticalIntegral(Int_t code, const char* rangeName) const
{
...
//     std::cout <<  "PdfSigAngMass_mF:analyticalIntegral1:mass  " << rtMassIntegral << " \t" << wtMassIntegral  << std::endl;
//     std::cout <<  "PdfSigAngMass_mF:analyticalIntegral1:ang   " << rtAngIntegral  << " \t" << wtAngIntegral    << std::endl;
...
//     std::cout <<  "PdfSigAngMass_mF:analyticalIntegral2:mass  " << rtMassIntegral << " \t" << wtMassIntegral  << std::endl;
//     std::cout <<  "PdfSigAngMass_mF:analyticalIntegral2:ang   " << rtAngIntegral  << " \t" << wtAngIntegral    << std::endl;
  }
...
//    rtMassIntegral = 1; //((RooAbsReal* )rtMass.createIntegral(*marg))->getVal();
//    wtMassIntegral = 1; //((RooAbsReal* )wtMass.createIntegral(*marg))->getVal();
//     std::cout <<  "PdfSigAngMass_mF:analyticalIntegral345:mass  " << rtMassIntegral << " \t" << wtMassIntegral  << std::endl;
    if ( fullRangeMass(m,rangeName) ) {
      rtMassIntegral = 1;
      wtMassIntegral = 1;
    } else {
...
//       std::cout <<  "PdfSigAngMass_mF:analyticalIntegral3:ang  " << rtAngIntegral << " \t" << wtAngIntegral  << std::endl;
    }
    else if (code ==4){
...
//       std::cout <<  "PdfSigAngMass_mF:analyticalIntegral4:ang  " << rtAngIntegral << " \t" << wtAngIntegral  << std::endl;
    }
    else if (code ==5){
...
//       std::cout <<  "PdfSigAngMass_mF:analyticalIntegral5:ang  " << rtAngIntegral << " \t" << wtAngIntegral  << std::endl;
    }
  }
