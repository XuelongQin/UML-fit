...
Output      = logs_parSub/simfit_data_fullAngularMass_Swave_f\$INT(wsc).out
Error       = logs_parSub/simfit_data_fullAngularMass_Swave_f\$INT(wsc).err
...
echo 'Queue 16'>>temp_sub_simfit_data_fullAngularMass_Swave_oneBin.sub
