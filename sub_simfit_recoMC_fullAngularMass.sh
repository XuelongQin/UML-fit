...
Output      = logs_parSub_explCon/simfit_recoMC_fullAngularMass_\$INT(nsamp)_\$INT(bin).out
Error       = logs_parSub_explCon/simfit_recoMC_fullAngularMass_\$INT(nsamp)_\$INT(bin).err
...
echo 'Queue 60'>>temp_sub_simfit_recoMC_fullAngularMass_oneBin.sub
