...
if [ "$bin" -lt 8 ]; then
    echo ./simfit_recoMC_fullAngularMass_toybkg_toyeff ${bin} ${par} ${neff} ${nsam} 1 ${plot} ${save} 2016 2017 2018
    ./simfit_recoMC_fullAngularMass_toybkg_toyeff ${bin} ${par} ${neff} ${nsam} 1 ${plot} ${save} 2016 2017 2018
else
    echo ./simfit_recoMC_fullAngularMass_toybkg_toyeff ${bin} ${par} ${neff} ${nsam} 1 ${plot} ${save} 2016
    ./simfit_recoMC_fullAngularMass_toybkg_toyeff ${bin} ${par} ${neff} ${nsam} 1 ${plot} ${save} 2016
fi
...
rm simfit_recoMC_fullAngularMass_toybkg_toyeff
rm recoMCDataset_b*
