...
if make simfit_data_fullAngularMass_Swave; then
	...
	0)
		...
		&> logs_simFit4d/simfit_data_fullAngularMass_Swave_${bin}_${par}_${multi}_${nsam}_${q2stat}_${fitopt}_${XGBv}_${localFile}_${plot}_${save}_2016_2017_2018.log &
	    ;;
	...
	1)
		...
		&> logs_simFit4d/simfit_data_fullAngularMass_Swave_${bin}_${par}_${multi}_${nsam}_${q2stat}_${fitopt}_${XGBv}_${localFile}_${plot}_${save}_2016.log &
	    ;;
	...
	2)
		...
		&> logs_simFit4d/simfit_data_fullAngularMass_Swave_${bin}_${par}_${multi}_${nsam}_${q2stat}_${fitopt}_${XGBv}_${localFile}_${plot}_${save}_2017.log &
	    ;;
	...
	3)
		...
		&> logs_simFit4d/simfit_data_fullAngularMass_Swave_${bin}_${par}_${multi}_${nsam}_${q2stat}_${fitopt}_${XGBv}_${localFile}_${plot}_${save}_2018.log &
	    ;;
