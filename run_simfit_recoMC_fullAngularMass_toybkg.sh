...
if [ "$bin" -lt 8 ]; then
    echo ./simfit_recoMC_fullAngularMass_toybkg ${bin} ${par} ${multi} ${nsam} 1 ${plot} ${save} 2016 2017 2018
    ./simfit_recoMC_fullAngularMass_toybkg ${bin} ${par} ${multi} ${nsam} 1 ${plot} ${save} 2016 2017 2018
else
    echo ./simfit_recoMC_fullAngularMass_toybkg ${bin} ${par} ${multi} ${nsam} 1 ${plot} ${save} 2016
    ./simfit_recoMC_fullAngularMass_toybkg ${bin} ${par} ${multi} ${nsam} 1 ${plot} ${save} 2016
fi
